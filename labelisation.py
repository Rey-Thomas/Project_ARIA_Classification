...
print(f'Nombre d images labélisées: {len(json_dict)}')


print('Labelisation des 6 classes: \n 0 pour "okay" \n 1 pour "Recoater hopping" \n 2 pour "Recoater streaking" \n 3 pour "Debris" \n 4 pour "Super elevation" \n 5 pour "Incomplete spreading"')
layer = []

#je cherche a faire une image en particulier pour le testset
if testset:
    layer_nb = '00041'
